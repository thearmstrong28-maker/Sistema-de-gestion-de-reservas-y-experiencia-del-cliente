...
let UsersController = class UsersController {
    ...
    createInternal(request, createInternalUserDto) {
        return this.usersService.createInternal(request.user, createInternalUserDto);
    }
    list(request, query) {
        return this.usersService.list(request.user, query);
    }
    update(request, id, updateUserDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, create_internal_user_dto_1.CreateInternalUserDto]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "createInternal", null);
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Req)()),
